...
over100m = df[df['price'] > 100000000]
print("\nCars over 100m:")
print(over100m[['manufacturer', 'model', 'year', 'price']].sort_values('price'))
...
over100m = len(df[df['price'] > 100000000])


print(f"\nWill be dropped:")
print(f"Missing prices: {missing_price} cars")
print(f"Under 200k: {under_200k} cars")
print(f"Over 100m: {over100m} cars")
print(f"TOTAL: {missing_price + under_200k + over100m} cars")
