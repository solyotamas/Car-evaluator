...
The best-performing model focused on cars from 2010 onwards in the price range of 2M–50M HUF.
Achieving validation **MSE < 0.02**, validation MAPE ≈ 10.6% while maintaining 11.1% MAPE on the test set.
