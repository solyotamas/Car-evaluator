...
## **Introduction**
A deep learning project using regression **MLPs** to predict the prices of cars available on the popular hungarian site [Hasznaltauto.hu](https://www.hasznaltauto.hu) aiming to find underpriced ones
